...
<body>
	...
	<%
		...
		String searchText = (String)(request.getParameter("searchBoxtext"));	
	%>
	<section id="main"> <article id="article"> 
	<%
 	ArrayList<Item> itemList = new ItemDAO().getSearchItem(searchText);
 	%>
	<div class="container">
					...
					<%}
						...
						<td align = "top">
							<table class = "table">
								...
								<tr>
									<td colspan="4" style = "height : 300px; maxwidth : 50%;">
									<a href = "Main.jsp?center=ItemInfo.jsp?no=<%=item.getItemNo()%>" target = "_blank">
									<img src = "img/game.png" style = "overflow : hidden;"></a></td>
								</tr>
								<tr>
									<td>1일</td>
									<td>30일</td>
